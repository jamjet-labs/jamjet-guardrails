...
under `unicode-data/16.0.0/`. Regenerate rather than edit: a test
...
Contents: 979 script ranges naming 170 scripts, and 174 Script_Extensions
ranges over 110 distinct sets. Both counts are held to this table by
...
EXTENSION_SETS: tuple[str, ...] = (
    "Adlam Arabic",
    "Adlam Arabic Garay Hanifi_Rohingya Nko Syriac Thaana Yezidi",
    "Adlam Arabic Hanifi_Rohingya Mandaic Manichaean Old_Uyghur Psalter_Pahlavi Sogdian Syriac",
    "Adlam Arabic Old_Hungarian",
    "Arabic Coptic",
    "Arabic Garay Hanifi_Rohingya Nko Syriac Thaana Yezidi",
    ...
    "Avestan Carian Coptic Duployan Elbasan Georgian Glagolitic Gothic Greek Gunjala_Gondi Han Latin Lydian Mahajani Old_Permic Shavian",
    "Avestan Carian Georgian Kaithi Lydian Old_Hungarian Samaritan",
    "Avestan Old_Turkic",
    "Bengali",
    "Bengali Chakma Syloti_Nagri",
    "Bengali Cyrillic Devanagari Latin Lisu Thai Toto",
    "Bengali Devanagari",
    "Bengali Devanagari Dogra Grantha Gujarati Gunjala_Gondi Gurmukhi Gurung_Khema Kannada Khudawadi Limbu Mahajani Malayalam Masaram_Gondi Nandinagari Ol_Onal Oriya Sinhala Syloti_Nagri Takri Tamil Telugu Tirhuta",
    "Bengali Devanagari Dogra Grantha Gujarati Gunjala_Gondi Gurmukhi Kannada Khudawadi Mahajani Malayalam Masaram_Gondi Nandinagari Ol_Onal Oriya Sinhala Syloti_Nagri Takri Tamil Telugu Tirhuta",
    ...
    "Bopomofo Han Hangul Hiragana Katakana Lisu Mongolian Tibetan Yi",
    "Bopomofo Han Hangul Hiragana Katakana Mongolian Phags_Pa Yi",
    "Bopomofo Han Hangul Hiragana Katakana Mongolian Tibetan Yi",
    "Bopomofo Han Hangul Hiragana Katakana Mongolian Yi",
    "Bopomofo Han Hangul Hiragana Katakana Yi",
    "Bopomofo Latin",
    "Buginese Javanese",
    "Buhid Hanunoo Tagalog Tagbanwa",
    "Carian Georgian Glagolitic Lycian Old_Hungarian Old_Turkic",
    "Carian Greek Meroitic_Hieroglyphs Old_Hungarian",
    ...
    "Cyrillic Old_Permic",
    "Devanagari",
    "Devanagari Dogra Gujarati Gurmukhi Kaithi Kannada Khojki Khudawadi Mahajani Malayalam Modi Nandinagari Sharada Takri Tirhuta Tulu_Tigalari",
    "Devanagari Dogra Gujarati Gurmukhi Kaithi Kannada Khojki Khudawadi Mahajani Modi Nandinagari Sharada Takri Tirhuta Tulu_Tigalari",
    "Devanagari Dogra Gujarati Gurmukhi Kaithi Khojki Khudawadi Mahajani Modi Sharada Takri Tirhuta",
    "Devanagari Dogra Gujarati Gurmukhi Kaithi Khojki Khudawadi Mahajani Modi Takri Tirhuta",
